...
<?php
	...
	$sql = "SELECT judul, waktu, isi, gambar, nama_kategori, nama, id_tulis FROM tbl_artikel, tbl_kategori, tbl_kontributor, tbl_tulis_artikel WHERE tbl_artikel.id_artikel = tbl_tulis_artikel.id_artikel AND tbl_kategori.id_kategori = tbl_tulis_artikel.id_kategori AND tbl_kontributor.id_kontributor = tbl_tulis_artikel.id_kontributor ";

	switch ($nama_kategori) {
		case 'Sistem Operasi':
			$sql = $sql . "AND tbl_kategori.nama_kategori = '$nama_kategori' ORDER BY id_tulis DESC";
			break;
		case 'Aplikasi':
			$sql = $sql . "AND tbl_kategori.nama_kategori = '$nama_kategori' ORDER BY id_tulis DESC";
			break;
		...
		case 'Kernel':
			...
			break;
		default:
			$sql = $sql . "ORDER BY id_tulis DESC";
			break;
	}

	$kategori_artikel_terpilih = query($sql);
?>
<head>
...
<body>
	<div class="container">
			...
			<ul>
				...
				<?php
					...
					foreach ($data_kategori as $item_kategori):
						if ($item_kategori['nama_kategori'] == $nama_kategori) {
		...
		<div class="content cf">
			<div class="article">
				<?php
					foreach ($kategori_artikel_terpilih as $item_artikel):
				?>
